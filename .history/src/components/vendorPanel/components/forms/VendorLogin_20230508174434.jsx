...
const VendorLogin = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev/api/v1/login",
        { phone, password }
      );
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center bg-slate-100"     style={{ backgroundColor: "#19376d" }}>
        <form
        ...
        >
          <p className="text-3xl" style={{ color  : '#19376d'  , fontSize : '2.5rem'} }> Admin Panel </p>
