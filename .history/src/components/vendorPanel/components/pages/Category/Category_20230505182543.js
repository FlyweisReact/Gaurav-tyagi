    ...
    const postData = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev//api/v1/admin/category/new",
  ...
  const deleteData = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev//api/v1/admin/delete/cat/${id}`
      );
      console.log(data);
      fetchData();
