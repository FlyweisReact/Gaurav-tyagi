    ...
    const fetchData = async () => {
      try {
        const { data } = await axios.get(
          "https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev//api/v1/terms",
      ...
      const postData = async (e) => {
        ...
        try {
          const { data } = await axios.put(
            "https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev/api/v1/terms/63e4d098eb79be1cd58ad351",
            { terms : couponCode }
          );
          console.log(data);
          props.onHide();
