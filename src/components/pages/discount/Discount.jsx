  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get(
        "https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev//api/v1/coupon/all",
        {
          headers: {
    ...
    const postData = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev//api/v1/coupon",
  ...
  const deleteData = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://6nkuu0ytgg.execute-api.ap-south-1.amazonaws.com/dev//api/v1/coupon/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
